...
#timesheet app homepage
def index(req):
    return render(req, 'index_timesheet.html')

#Calendar widget and timesheet table, modal
@login_required
def entry(req):
    return render(req, 'set_date.html')

#Get date from date picker, and generate daily timesheet dates
@login_required
...
#after timesheet submission, goes to this page
@login_required

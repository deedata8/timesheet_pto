"""
Django settings for timesheetptoProj project.
...
SECRET_KEY = 'kht&f&2+ynux)shpl+2te#kzf5pf5_&isc%ownkhk9k_0qn0hi'
...
ROOT_URLCONF = 'timesheetptoProj.urls'
...
WSGI_APPLICATION = 'timesheetptoProj.wsgi.application'
